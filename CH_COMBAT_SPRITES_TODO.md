...
> **Bijgewerkt 2026-08-24.** Er zijn elf nieuwe COMBAT-gevechten bijgekomen
> in Hoofdstuk 18 t/m 27 (post-build audit, Chronica.md §7.107) — tot die
> ronde had de hele tweede helft van de campagne één enkel gevecht. **Zes van
> de elf sprites zijn inmiddels getekend en staan in de map**; de laatste vijf
> staan hieronder nog open, met een kant-en-klare prompt per stuk. Ook
> `fin_lethe.png` is er nu. De vijf resterende gevechten zijn intussen gewoon
> speelbaar: `spCombatSpriteHTML()` valt bij een ontbrekend bestand stil terug
> op het emoji-icoon van de vijand, dus er is geen kapotte afbeelding te zien.

**Status: 23 van de 28 compleet.** Alle 16 oorspronkelijke entries in
...
Nog te doen (5): `nijlkrokodillen.png`, `proscriptie_sluipmoordenaars.png`,
`agrippas_vloot.png`, `antonius_vloot.png`, `visigoten.png`. Zijn die klaar, dan
is de lijst weer volledig: 28 van 28.
